...
<div class="topbar">
    ...
    <div class="topbar-right">
        ...
        <!-- Уведомления -->
        <div class="topbar-action" onclick="toggleNotifications()">
            <span>🔔</span>
            <?php if ($notificationCount > 0): ?>
            <span class="topbar-action-badge"><?= $notificationCount ?></span>
            <?php endif; ?>
        </div>
...
function toggleNotifications() {
    // Здесь будет логика открытия панели уведомлений
    alert('Панель уведомлений в разработке');
}
